...
<footer class="page-footer">
    <a href="https://www.tianlingzi.top" target="_blank" rel="noopener">灵感小屋</a>
    <span class="sep">·</span>
    <a href="https://www.tianlingzi.top/bing" target="_blank" rel="noopener">每日壁纸主页</a>
    <span class="sep">·</span>
    <a href="https://r2.tianlingzi.ccwu.cc/BingWallpaper.exe">下载 Windows 客户端</a>
</footer>
...
.page-footer a:hover {
    color: #c9e0ff;
    background: rgba(80, 167, 242, 0.08);
}
.page-footer .sep {
    margin: 0 8px;
    color: #444;
